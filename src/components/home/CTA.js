                ...
                <form className="mt-12 sm:flex justify-center">
                    <div className="relative flex items-center w-full max-w-2xl">
                        <input
                            ...
                            className="flex-1 rounded-lg border-transparent appearance-none border border-gray-300 py-4 px-6 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
