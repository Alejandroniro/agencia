    ...
    <footer className="bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="flex">
              {navigation.social.map((item) => (
                ...
                >
                  ...
                  <item.icon className="h-8 w-8 rounded-full bg-white shadow-navbar transition-all duration-300 ease-in-out hover:bg-orange-button" aria-hidden="true" />
                </a>
              ))}
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">&copy; Copyright, Trabook 2022. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
